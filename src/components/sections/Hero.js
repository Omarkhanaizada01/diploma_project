...
<div className="relative z-20 p-12 text-white flex h-full items-center">
  {/* Green Accent Line */}
  <div className="h-[65px] w-[2px] bg-[#84D187] mr-1 mt-16 " />
  
  <div className="max-w-[596px]">
    {/* Main Title */}
    <h2 className="text-[48px] font-semibold leading-[120%] mb-4 text-white font-poppins">
      Fresh & Healthy<br />Organic Food
    </h2>
    
    {/* Sale Badge - теперь на одном уровне с зеленой линией */}
    <div className="flex items-center gap-[10px] mb-4 ml-4 ">
    ...
    {/* Subtitle */}
    <p className="text-[14px] leading-[150%] text-white/80 font-poppins w-[215px] mb-6 ml-4">
      ...
      Shop now
        ...
        <div className="flex flex-col gap-4 w-full md:w-auto">
          ...
          <div className="relative w-full md:w-[423px] h-[288px] rounded-[10px] overflow-hidden">
            ...
            {/* Контент баннера */}
            <div className="absolute z-20 top-[32px] left-[32px] flex flex-col gap-[8px] w-[156px] h-[136px]">
              <h4 className=" text-[14px] text-black  ">SUMMER SALE</h4>
              <p className="text-black font-bold text-[32px] ">75% OFF</p>
              <p className="text-[#666666] text-[13px] whitespace-nowrap">Only Fruit & Vegetable</p>
          ...
          <div className="relative w-full md:w-[423px] h-[288px] rounded-[10px] overflow-hidden">
            ...
            <div className="relative z-20 p-6 h-full flex flex-col justify-center text-white">
              <p className="text-white/80 text-center mb-2">BEST DEAL</p>
              <h4 className="font-bold text-xl text-center mb-2">Special Products</h4>
      
              <p className="text-white font-bold text-xl text-center mb-4">Deal of the Month</p>
