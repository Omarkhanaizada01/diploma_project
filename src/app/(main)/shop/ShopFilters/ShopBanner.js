// src/app/(main)/shop/ShopFilters/ShopBanner.js// src/app/(main)/shop/ShopFilters/ShopBanner.js
// src/app/(main)/shop/ShopFilters/ShopBanner.js
import Image from 'next/image';
import ArrowButton from '../../../../components/ui/buttons/ArrowButton'; // Правильный путь
  ...
  return (
    <div className="w-[312px] h-[295px] rounded-[10px] overflow-hidden flex flex-col">
      ...
      <div className="relative flex-1 w-full overflow-hidden">
        <div className="absolute top-0 left-0 right-[-10px] bottom-[-50px]"> 
          <Image
